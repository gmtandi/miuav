...
public class TitleLayout extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        int bitmapRes = C2178R.getBitmapRes(context, "ssdk_back_arr");
        if (bitmapRes > 0) {
            this.btnBack.setImageResource(bitmapRes);
        }
        this.btnBack.setScaleType(ScaleType.CENTER_INSIDE);
        this.btnBack.setLayoutParams(new LayoutParams(C2178R.dipToPx(context, 48), -1));
        addView(this.btnBack);
        View imageView = new ImageView(context);
        int dipToPx = C2178R.dipToPx(context, 2);
        int bitmapRes2 = C2178R.getBitmapRes(context, "ssdk_title_div");
        if (bitmapRes2 > 0) {
        ...
        bitmapRes = C2178R.dipToPx(context, 23);
        ...
        bitmapRes2 = C2178R.getBitmapRes(context, "ssdk_title_div");
        if (bitmapRes2 > 0) {
            imageView.setImageResource(bitmapRes2);
        }
        imageView.setLayoutParams(new LayoutParams(dipToPx, -1));
        addView(imageView);
        this.btnRight = new C0197q(this, context, imageView);
        this.btnRight.setVisibility(4);
        this.btnRight.setBackgroundDrawable(null);
        this.btnRight.setMinWidth(C2178R.dipToPx(context, 50));
