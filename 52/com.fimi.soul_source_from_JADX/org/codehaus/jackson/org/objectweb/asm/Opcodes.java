...
public interface Opcodes {
    ...
    static {
        TOP = new Integer(NOP);
        INTEGER = new Integer(F_APPEND);
        FLOAT = new Integer(ICONST_M1);
        DOUBLE = new Integer(ICONST_0);
        LONG = new Integer(T_BOOLEAN);
        NULL = new Integer(T_CHAR);
        UNINITIALIZED_THIS = new Integer(T_FLOAT);
    }
}
