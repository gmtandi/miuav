...
public class TransportMediator extends TransportController {
    ...
    class C00551 implements TransportMediatorCallback {
        C00551() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C00551();
        this.mKeyEventCallback = new C00562();
        this.mContext = activity != null ? activity : view.getContext();
        this.mCallbacks = transportPerformer;
        this.mAudioManager = (AudioManager) this.mContext.getSystemService(FimiMediaMeta.IJKM_VAL_TYPE__AUDIO);
        if (activity != null) {
