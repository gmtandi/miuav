...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) size) * 0.8f), C1186y.f5353a);
        i3 = MeasureSpec.makeMeasureSpec(i3, C1186y.f5353a);
    ...
    public void setNonPrimaryAlpha(float f) {
        this.mNonPrimaryAlpha = ((int) (255.0f * f)) & Util.MASK_8BIT;
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        count = MeasureSpec.makeMeasureSpec((int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f), C1186y.f5353a);
        height = MeasureSpec.makeMeasureSpec(height, C1186y.f5353a);
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        switch (this.mGravity & Opcodes.IREM) {
