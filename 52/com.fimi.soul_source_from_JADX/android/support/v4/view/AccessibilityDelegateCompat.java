...
public class AccessibilityDelegateCompat {
    ...
    class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        class C00711 implements AccessibilityDelegateBridge {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C00711(AccessibilityDelegateCompat accessibilityDelegateCompat) {
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new C00711(accessibilityDelegateCompat));
        }
    ...
    class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        class C00721 implements AccessibilityDelegateBridgeJellyBean {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C00721(AccessibilityDelegateCompat accessibilityDelegateCompat) {
                this.val$compat = accessibilityDelegateCompat;
            }
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new C00721(accessibilityDelegateCompat));
        }
