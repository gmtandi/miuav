...
class ViewPropertyAnimatorCompatICS {
    ...
    final class C00871 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorListener val$listener;
        final /* synthetic */ View val$view;

        C00871(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        view.animate().setListener(new C00871(viewPropertyAnimatorListener, view));
    }
    ...
    public static void m126x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m127y(View view, float f) {
        view.animate().y(f);
    }
