...
public class ViewPager extends ViewGroup {
    ...
    final class C00801 implements Comparator<ItemInfo> {
        C00801() {
        }
    ...
    final class C00812 implements Interpolator {
        C00812() {
        }

        public float getInterpolation(float f) {
            float f2 = f - C2020f.f10933c;
            return (f2 * (((f2 * f2) * f2) * f2)) + C2020f.f10933c;
        }
    }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() == Opcodes.ACC_SYNTHETIC && ViewPager.this.mAdapter != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                accessibilityNodeInfoCompat.addAction(Opcodes.ACC_SYNTHETIC);
            }
            if (ViewPager.this.canScrollHorizontally(ViewPager.INVALID_POINTER)) {
                accessibilityNodeInfoCompat.addAction(Opcodes.ACC_ANNOTATION);
            }
        }
    ...
    public class SavedState extends BaseSavedState {
        ...
        final class C00831 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00831() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00831());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00801();
        sInterpolator = new C00812();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00823();
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        this.mLastOffset = itemInfo.position == count + INVALID_POINTER ? (itemInfo.offset + itemInfo.widthFactor) - C2020f.f10933c : AutoScrollHelper.NO_MAX;
        ...
        for (i3 = i + SCROLL_STATE_DRAGGING; i3 < size; i3 += SCROLL_STATE_DRAGGING) {
            ...
            if (itemInfo3.position == count + INVALID_POINTER) {
                this.mLastOffset = (itemInfo3.widthFactor + f) - C2020f.f10933c;
            }
            itemInfo3.offset = f;
            f3 = f + (itemInfo3.widthFactor + f2);
            i2 += SCROLL_STATE_DRAGGING;
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        if (accessibilityEvent.getEventType() == Opcodes.ACC_SYNTHETIC) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == SCROLL_STATE_DRAGGING && this.mAdapter != null && this.mAdapter.getCount() > SCROLL_STATE_DRAGGING)) {
            ...
            if (!this.mRightEdge.isFinished()) {
                ...
                canvas.rotate(90.0f);
                canvas.translate((float) (-getPaddingTop()), (-(this.mLastOffset + C2020f.f10933c)) * ((float) height));
    ...
    public void endFakeDrag() {
        if (this.mFakeDragging) {
            ...
            velocityTracker.computeCurrentVelocity(XiaomiOAuthConstants.SCOPE_ACCESS_MI_ROUTER, (float) this.mMaximumVelocity);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i8 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isDecor) {
                    int i9 = layoutParams.gravity & Opcodes.IREM;
        ...
        for (int i5 = SCROLL_STATE_IDLE; i5 < childCount; i5 += SCROLL_STATE_DRAGGING) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    int i7 = layoutParams.gravity & Opcodes.IREM;
                    i3 = C1186y.f5353a;
                    i4 = C1186y.f5353a;
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        float distanceInfluenceForSnapDuration = (((float) i6) * distanceInfluenceForSnapDuration(Math.min(C2020f.f10933c, (((float) Math.abs(i4)) * C2020f.f10933c) / ((float) clientWidth)))) + ((float) i6);
        int abs = Math.abs(i3);
        if (abs > 0) {
            clientWidth = Math.round(1000.0f * Math.abs(distanceInfluenceForSnapDuration / ((float) abs))) * 4;
        } else {
            clientWidth = (int) (((((float) Math.abs(i4)) / ((((float) clientWidth) * this.mAdapter.getPageWidth(this.mCurItem)) + ((float) this.mPageMargin))) + C2020f.f10933c) * 100.0f);
        }
