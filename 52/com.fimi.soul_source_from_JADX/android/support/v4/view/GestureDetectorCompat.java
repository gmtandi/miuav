...
public class GestureDetectorCompat {
    ...
    class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            boolean z = (action & Util.MASK_8BIT) == 6;
            ...
            switch (action & Util.MASK_8BIT) {
                ...
                case SHOW_PRESS /*1*/:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(XiaomiOAuthConstants.SCOPE_ACCESS_MI_ROUTER, (float) this.mMaximumFlingVelocity);
                ...
                case LONG_PRESS /*2*/:
                    ...
                    if (this.mAlwaysInTapRegion) {
                        ...
                        return hasMessages;
                    } else if (Math.abs(xVelocity) < C2020f.f10933c && Math.abs(yVelocity) < C2020f.f10933c) {
                        return false;
                    } else {
                ...
                case Type.FLOAT /*6*/:
                    ...
                    this.mLastFocusY = f;
                    this.mDownFocusY = f;
                    this.mVelocityTracker.computeCurrentVelocity(XiaomiOAuthConstants.SCOPE_ACCESS_MI_ROUTER, (float) this.mMaximumFlingVelocity);
