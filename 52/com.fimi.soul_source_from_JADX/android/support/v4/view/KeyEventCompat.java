...
public class KeyEventCompat {
    ...
    class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public boolean metaStateHasModifiers(int i, int i2) {
            return metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(i) & META_MODIFIER_MASK, i2, 1, 64, SmileConstants.TOKEN_PREFIX_TINY_UNICODE), i2, 2, 16, 32) == i2;
        }
        ...
        public int normalizeMetaState(int i) {
            int i2 = (i & SmileConstants.TOKEN_PREFIX_SMALL_INT) != 0 ? i | 1 : i;
            if ((i2 & 48) != 0) {
                i2 |= 2;
            }
