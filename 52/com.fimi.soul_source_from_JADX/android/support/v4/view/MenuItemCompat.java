...
public class MenuItemCompat {
    ...
    class IcsMenuVersionImpl extends HoneycombMenuVersionImpl {
        ...
        public MenuItem setOnActionExpandListener(MenuItem menuItem, OnActionExpandListener onActionExpandListener) {
            return onActionExpandListener == null ? MenuItemCompatIcs.setOnActionExpandListener(menuItem, null) : MenuItemCompatIcs.setOnActionExpandListener(menuItem, new C00751(onActionExpandListener));
        }
    }
