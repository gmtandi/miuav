...
class AccessibilityManagerCompatIcs {
    ...
    final class C00891 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00891(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
    ...
    public static Object newAccessibilityStateChangeListener(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
        return new C00891(accessibilityStateChangeListenerBridge);
    }
