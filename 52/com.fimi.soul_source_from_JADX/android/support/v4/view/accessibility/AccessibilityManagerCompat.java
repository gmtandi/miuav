...
public class AccessibilityManagerCompat {
    ...
    class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        class C00881 implements AccessibilityStateChangeListenerBridge {
            final /* synthetic */ AccessibilityStateChangeListenerCompat val$listener;

            C00881(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
        ...
        public Object newAccessiblityStateChangeListener(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
            return AccessibilityManagerCompatIcs.newAccessibilityStateChangeListener(new C00881(accessibilityStateChangeListenerCompat));
        }
