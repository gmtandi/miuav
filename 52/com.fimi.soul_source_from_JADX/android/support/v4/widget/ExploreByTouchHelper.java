...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int i) {
        ...
        if ((actions & 64) != 0) {
        ...
        } else if ((actions & SmileConstants.TOKEN_PREFIX_TINY_UNICODE) != 0) {
            ...
            if (this.mFocusedVirtualViewId == i) {
                ...
                obtain.addAction(SmileConstants.TOKEN_PREFIX_TINY_UNICODE);
            } else {
    ...
    private boolean requestAccessibilityFocus(int i) {
        ...
        this.mView.invalidate();
        sendEventForVirtualView(i, C0957d.f5043a);
        return true;
    }
    ...
    private void updateHoveredVirtualView(int i) {
        if (this.mHoveredVirtualViewId != i) {
            ...
            sendEventForVirtualView(i, SmileConstants.TOKEN_PREFIX_TINY_UNICODE);
            sendEventForVirtualView(i2, Opcodes.ACC_NATIVE);
        }
    }
    ...
    public void invalidateVirtualView(int i) {
        sendEventForVirtualView(i, Opcodes.ACC_STRICT);
    }
