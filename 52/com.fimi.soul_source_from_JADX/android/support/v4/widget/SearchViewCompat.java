...
public class SearchViewCompat {
    ...
    class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C01011 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            C01011(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class C01022 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            C01022(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnCloseListener(OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C01022(onCloseListenerCompat));
        }

        public Object newOnQueryTextListener(OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C01011(onQueryTextListenerCompat));
        }
