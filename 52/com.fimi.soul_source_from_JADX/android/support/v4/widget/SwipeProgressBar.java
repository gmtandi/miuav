...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            float f = ((float) ((currentAnimationTimeMillis - this.mStartTime) % 2000)) / TitleBar.BACKBTN_LEFT_MARGIN;
            Object obj;
            if (this.mRunning) {
                obj = null;
            } else {
                ...
                float interpolation = INTERPOLATOR.getInterpolation((((float) ((currentAnimationTimeMillis - this.mFinishTime) % 1000)) / TitleBar.SHAREBTN_RIGHT_MARGIN) / 100.0f) * f2;
