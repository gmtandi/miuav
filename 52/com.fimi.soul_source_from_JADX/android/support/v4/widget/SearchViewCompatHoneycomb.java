...
class SearchViewCompatHoneycomb {
    ...
    final class C01031 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01031(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    final class C01042 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01042(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
