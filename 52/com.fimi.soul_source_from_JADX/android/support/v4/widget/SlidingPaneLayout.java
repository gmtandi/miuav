...
public class SlidingPaneLayout extends ViewGroup {
    ...
    class SavedState extends BaseSavedState {
        ...
        final class C01061 implements Creator<SavedState> {
            C01061() {
            }
    ...
    private boolean openPane(View view, int i) {
        if (!this.mFirstLayout && !smoothSlideTo(C2020f.f10933c, i)) {
            return false;
        }
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    ...
                    if (childAt == this.mSlideableView) {
                        i2 = (int) ((C2020f.f10933c - this.mParallaxOffset) * ((float) this.mParallaxBy));
                        this.mParallaxOffset = f;
                        i2 -= (int) ((C2020f.f10933c - f) * ((float) this.mParallaxBy));
                        if (isLayoutRtlSupport) {
                            i2 = -i2;
                        }
                        childAt.offsetLeftAndRight(i2);
                        if (obj == null) {
                            dimChildView(childAt, isLayoutRtlSupport ? this.mParallaxOffset - C2020f.f10933c : C2020f.f10933c - this.mParallaxOffset, this.mCoveredFadeColor);
                        }
                    }
                }
            }
    ...
    public boolean isOpen() {
        return !this.mCanSlide || this.mSlideOffset == C2020f.f10933c;
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mFirstLayout) {
            float f = (this.mCanSlide && this.mPreservedOpenState) ? C2020f.f10933c : 0.0f;
            this.mSlideOffset = f;
        }
        int i6 = 0;
        int i7 = paddingRight;
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    i8 = (int) ((C2020f.f10933c - this.mSlideOffset) * ((float) this.mParallaxBy));
                    i10 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i9 = (i5 - i10) + i8;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                mode = layoutParams.width == -2 ? MeasureSpec.makeMeasureSpec(paddingLeft - mode, C1186y.f5353a) : layoutParams.width == -1 ? MeasureSpec.makeMeasureSpec(paddingLeft - mode, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                i8 = layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, C1186y.f5353a) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                ...
                if (childAt2.getVisibility() != 8) {
                    ...
                    if (childAt2.getVisibility() != 8) {
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                mode = layoutParams.width == 0 ? layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, C1186y.f5353a) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
                                if (z) {
                            ...
                            size2 = obj != null ? layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, C1186y.f5353a) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
