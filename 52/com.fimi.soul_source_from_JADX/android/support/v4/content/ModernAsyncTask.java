...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    final class C00511 implements ThreadFactory {
    ...
    class C00522 extends WorkerRunnable<Params, Result> {
        C00522() {
            super();
        }
    ...
    class C00533 extends FutureTask<Result> {
        C00533(Callable callable) {
            super(callable);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00522();
        this.mFuture = new C00533(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            switch (C00544.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
