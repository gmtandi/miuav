...
public class FragmentActivity extends Activity {
    ...
    class C00342 implements FragmentContainer {
        C00342() {
        }
    ...
    public FragmentActivity() {
        this.mHandler = new C00331();
        this.mFragments = new FragmentManagerImpl();
        this.mContainer = new C00342();
    }
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i3 != 0) {
            ...
            if (fragment == null) {
                ...
                fragment.onActivityResult(Util.MASK_16BIT & i, i2, intent);
                return;
            }
        }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i) {
        if (i == -1) {
            ...
            super.startActivityForResult(intent, ((fragment.mIndex + MSG_REALLY_STOPPED) << 16) + (Util.MASK_16BIT & i));
        }
    }
