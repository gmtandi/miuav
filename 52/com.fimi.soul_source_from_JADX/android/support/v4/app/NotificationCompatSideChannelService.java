...
public abstract class NotificationCompatSideChannelService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        return (!intent.getAction().equals(NotificationManagerCompat.ACTION_BIND_SIDE_CHANNEL) || VERSION.SDK_INT >= BUILD_VERSION_CODE_KITKAT_WATCH) ? null : new NotificationSideChannelStub();
    }
}
