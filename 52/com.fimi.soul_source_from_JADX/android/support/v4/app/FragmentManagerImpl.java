...
final class FragmentManagerImpl extends FragmentManager {
    ...
    class C00395 implements AnimationListener {
        final /* synthetic */ Fragment val$fragment;

        C00395(Fragment fragment) {
    ...
    Animation loadAnimation(Fragment fragment, int i, boolean z, int i2) {
        ...
        switch (transitToStyleIndex) {
            case ANIM_STYLE_OPEN_ENTER /*1*/:
                return makeOpenCloseAnimation(this.mActivity, 1.125f, C2020f.f10933c, 0.0f, C2020f.f10933c);
            case ANIM_STYLE_OPEN_EXIT /*2*/:
                return makeOpenCloseAnimation(this.mActivity, C2020f.f10933c, 0.975f, C2020f.f10933c, 0.0f);
            case ANIM_STYLE_CLOSE_ENTER /*3*/:
                return makeOpenCloseAnimation(this.mActivity, 0.975f, C2020f.f10933c, 0.0f, C2020f.f10933c);
            case ANIM_STYLE_CLOSE_EXIT /*4*/:
                return makeOpenCloseAnimation(this.mActivity, C2020f.f10933c, 1.075f, C2020f.f10933c, 0.0f);
            case ANIM_STYLE_FADE_ENTER /*5*/:
                return makeFadeAnimation(this.mActivity, 0.0f, C2020f.f10933c);
            case ANIM_STYLE_FADE_EXIT /*6*/:
                return makeFadeAnimation(this.mActivity, C2020f.f10933c, 0.0f);
            default:
    ...
    public void popBackStack() {
        enqueueAction(new C00362(), HONEYCOMB);
    }
    ...
    public void popBackStack(int i, int i2) {
        ...
        enqueueAction(new C00384(i, i2), HONEYCOMB);
    }

    public void popBackStack(String str, int i) {
        enqueueAction(new C00373(str, i), HONEYCOMB);
    }
