...
public class AsyncHttpClient {
    ...
    class C21101 implements HttpRequestInterceptor {
        C21101() {
        }
    ...
    class C21112 implements HttpResponseInterceptor {
        C21112() {
        }
    ...
    public AsyncHttpClient() {
        ...
        this.httpClient.addRequestInterceptor(new C21101());
        this.httpClient.addResponseInterceptor(new C21112());
