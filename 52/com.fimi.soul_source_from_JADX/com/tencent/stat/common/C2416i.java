...
class C2416i extends C2415h {
    private static final int[] f12335c;
    ...
    public C2416i(int i, byte[] bArr) {
        this.a = bArr;
        this.f12339g = (i & 8) == 0 ? f12335c : f12336d;
        this.f12337e = 0;
        this.f12338f = 0;
    }
    ...
    public boolean m14000a(byte[] r11, int r12, int r13, boolean r14) {
        /*
        r10 = this;
        r0 = r10.f12337e;
        r1 = 6;
