...
public class C2343f extends SQLiteOpenHelper {
    protected static final String f12031a;
    protected static final String[] f12032b;
    protected static C2343f f12033c;

    static {
        f12031a = C2333f.f12014d + ".ReportDatabaseHelper";
        f12032b = new String[]{SharedPref.KEY};
    }

    public C2343f(Context context) {
        super(context, "sdk_report.db", null, 2);
    }

    public static synchronized C2343f m13791a() {
        C2343f c2343f;
        synchronized (C2343f.class) {
            if (f12033c == null) {
                f12033c = new C2343f(Global.getContext());
            }
            c2343f = f12033c;
        }
        return c2343f;
    ...
    public synchronized java.util.List<java.io.Serializable> m13792a(java.lang.String r12) {
        /*
        r11 = this;
        r9 = 0;
        monitor-enter(r11);
    ...
    L_0x0092:
        ...
        r1 = r3;
    L_0x0094:
        r2 = f12031a;	 Catch:{ all -> 0x00db }
        r3 = "getReportItemFromDB has exception.";
        com.tencent.open.p133a.C2333f.m13759e(r2, r3);	 Catch:{ all -> 0x00db }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m13793a(java.lang.String r9, java.util.List<java.io.Serializable> r10) {
        /*
        r8 = this;
        r2 = 0;
        r1 = 20;
    ...
    L_0x0015:
        r8.m13794b(r9);	 Catch:{ all -> 0x008f }
    ...
    L_0x007d:
        r0 = move-exception;
        r0 = f12031a;	 Catch:{ all -> 0x009f }
        r1 = "saveReportItemToDB has exception.";
        com.tencent.open.p133a.C2333f.m13759e(r0, r1);	 Catch:{ all -> 0x009f }
    ...
    public synchronized void m13794b(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (writableDatabase != null) {
                try {
                    ...
                    C2333f.m13759e(f12031a, "clearReportItem has exception.");
                    if (writableDatabase != null) {
                        writableDatabase.close();
                    }
                } catch (Throwable th) {
