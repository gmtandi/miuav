...
public class ServerSetting {
    ...
    private static ServerSetting f12106b;
    private volatile WeakReference<SharedPreferences> f12107c;

    static {
        f12105a = C2333f.f12014d + "." + ServerSetting.class.getName();
        f12106b = null;
    }
    ...
    public static synchronized ServerSetting getInstance() {
        ...
        synchronized (ServerSetting.class) {
            if (f12106b == null) {
                f12106b = new ServerSetting();
            }
            serverSetting = f12106b;
        }
    ...
    public String getEnvUrl(Context context, String str) {
        if (this.f12107c == null || this.f12107c.get() == null) {
            this.f12107c = new WeakReference(context.getSharedPreferences("ServerPrefs", ENVIRONMENT_NORMOL));
        }
        try {
            Object host = new URL(str).getHost();
            if (host == null) {
                C2333f.m13759e(f12105a, "Get host error. url=" + str);
            } else {
                Object string = ((SharedPreferences) this.f12107c.get()).getString(host, null);
                if (string == null || host.equals(string)) {
                    C2333f.m13754b(f12105a, "host=" + host + ", envHost=" + string);
                } else {
                    str = str.replace(host, string);
                    C2333f.m13754b(f12105a, "return environment url : " + str);
                }
            }
        } catch (Exception e) {
            C2333f.m13759e(f12105a, "getEnvUrl url=" + str + "error.: " + e.getMessage());
        }
        return str;
    }

    public void setEnvironment(Context context, int i) {
        if (context != null && (this.f12107c == null || this.f12107c.get() == null)) {
            this.f12107c = new WeakReference(context.getSharedPreferences("ServerPrefs", ENVIRONMENT_NORMOL));
        }
        if (i == 0 || i == ENVIRONMENT_EXPERIENCE) {
            ...
            switch (i) {
                case ENVIRONMENT_NORMOL /*0*/:
                    edit = ((SharedPreferences) this.f12107c.get()).edit();
        ...
        C2333f.m13759e(f12105a, "\u5207\u6362\u73af\u5883\u53c2\u6570\u9519\u8bef\uff0c\u6b63\u5f0f\u73af\u5883\u4e3a0\uff0c\u4f53\u9a8c\u73af\u5883\u4e3a1");
    }
}
