...
public class SystemUtils {
    ...
    private static final String f12108a;

    static {
        f12108a = C2333f.f12014d + ".SysUtils";
    }

    private static long m13845a(InputStream inputStream, OutputStream outputStream) {
        long j = 0;
        ...
        while (true) {
            ...
            if (read != -1) {
                ...
                C2333f.m13757c(f12108a, "-->copy, copyed size is: " + j);
                return j;
            }
        }
    }
    ...
    public static boolean checkMobileQQ(Context context) {
        ...
        try {
            C2333f.m13754b("MobileQQ verson", str);
    ...
    public static boolean extractSecureLib(String str, String str2, int i) {
        ...
        C2333f.m13757c(f12108a, "-->extractSecureLib, libName: " + str);
        Context context = Global.getContext();
        if (context == null) {
            C2333f.m13757c(f12108a, "-->extractSecureLib, global context is null. ");
            return false;
        }
        SharedPreferences sharedPreferences = context.getSharedPreferences("secure_lib", 0);
        File file = new File(context.getFilesDir(), str2);
        if (file.exists()) {
            int i2 = sharedPreferences.getInt(C2537j.aq, 0);
            C2333f.m13757c(f12108a, "-->extractSecureLib, libVersion: " + i + " | oldVersion: " + i2);
            if (i == i2) {
                return true;
            }
        ...
        try {
            ...
            try {
                ...
                m13845a(open, outputStream);
                Editor edit = sharedPreferences.edit();
                edit.putInt(C2537j.aq, i);
                edit.commit();
                if (open != null) {
                    try {
                        open.close();
                ...
                e = e5;
                try {
                    C2333f.m13755b(f12108a, "-->extractSecureLib, when copy lib execption.", e);
                    if (open != null) {
                        try {
                            open.close();
    ...
    public static String getAppSignatureMD5(Context context, String str) {
        String packageName;
        Throwable e;
        C2333f.m13751a(C2333f.f12014d, "OpenUi, getSignValidString");
        ...
        try {
            ...
            instance.reset();
            C2333f.m13754b("SystemUtils", "-->sign: " + toHexString);
            instance.update(Util.getBytesUTF8(packageName + "_" + toHexString + "_" + str + C2915a.f14760f));
            packageName = Util.toHexString(instance.digest());
            try {
                instance.reset();
                C2333f.m13754b("SystemUtils", "-->signEncryped: " + packageName);
            } catch (Exception e2) {
                e = e2;
                e.printStackTrace();
                C2333f.m13755b(C2333f.f12014d, "OpenUi, getSignValidString error", e);
                return packageName;
            }
        } catch (Throwable e3) {
            Throwable th = e3;
    ...
    public static boolean isAppSignatureValid(Context context, String str, String str2) {
        C2333f.m13751a(C2333f.f12014d, "OpenUi, validateAppSignatureForPackage");
        try {
    ...
    public static boolean isLibExtracted(String str, int i) {
        Context context = Global.getContext();
        if (context == null) {
            C2333f.m13757c(f12108a, "-->isSecureLibExtracted, global context is null. ");
            return false;
        }
