...
final class LogHelper {
    ...
    static {
        au = new byte[]{(byte) 4, (byte) 0, (byte) 0, (byte) 0, (byte) -1, (byte) -1, (byte) -1, (byte) 0};
    }
    ...
    public static void writeToStream(PrintStream printStream, byte[] bArr, String str, String str2) {
        if (printStream != null && !Util.isNullOrNil(bArr) && !Util.isNullOrNil(str) && !Util.isNullOrNil(str2)) {
            synchronized (printStream) {
                ...
                stringBuffer.append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(str).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(str2);
