...
public final class C2265q {
    ...
    private static boolean f11743b;

    static {
        f11742a = 0;
    }

    private static C2262n m13512a(HttpURLConnection httpURLConnection, boolean z) {
        int i = 1;
        int i2 = 0;
        ...
        try {
            ...
            if (inputStream != null) {
                c2262n.f11740a = new byte[0];
                Object obj = new byte[SmileConstants.MAX_SHARED_STRING_VALUES];
                int read;
                do {
                    ...
                    if (read > 0) {
                        ...
                        System.arraycopy(c2262n.f11740a, 0, obj2, 0, c2262n.f11740a.length);
                        System.arraycopy(obj, 0, obj2, c2262n.f11740a.length, read);
                        c2262n.f11740a = obj2;
                        continue;
                    }
                } while (read > 0);
    ...
    public static com.tencent.map.p131b.C2262n m13513a(boolean r6, java.lang.String r7, java.lang.String r8, java.lang.String r9, byte[] r10, boolean r11, boolean r12) {
        /*
        r2 = 1;
        r0 = 0;
        r1 = 0;
        r3 = com.tencent.map.p131b.C2260l.m13509d();
    ...
    L_0x0009:
        ...
        throw r0;
    L_0x000f:
        r3 = com.tencent.map.p131b.C2265q.m13514a(r7, r12);	 Catch:{ p -> 0x011b, Exception -> 0x0115, all -> 0x010f }
        r4 = 0;
        r4 = com.tencent.map.p131b.C2231b.m13370a(r4);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x002f:
        r4 = com.tencent.map.p131b.C2259k.m13496a();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r3.setConnectTimeout(r4);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r4 = com.tencent.map.p131b.C2259k.m13501b();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x0059:
        com.tencent.map.p131b.C2259k.m13499a(r3);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r3.connect();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        com.tencent.map.p131b.C2259k.m13504c();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x0087:
        com.tencent.map.p131b.C2259k.m13505d();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r2 = com.tencent.map.p131b.C2265q.m13512a(r3, r6);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        if (r2 == 0) goto L_0x0097;
    L_0x0090:
        r4 = r2.f11740a;	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        if (r4 == 0) goto L_0x0097;
    L_0x0094:
        r0 = r2.f11740a;	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r0 = r0.length;	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    L_0x0097:
        com.tencent.map.p131b.C2259k.m13498a(r0);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x00a9:
        r3 = 1;
        com.tencent.map.p131b.C2259k.m13500a(r3);	 Catch:{ all -> 0x00ae }
    ...
    L_0x00c3:
        r2 = 0;
        com.tencent.map.p131b.C2259k.m13500a(r2);	 Catch:{ all -> 0x00c8 }
    ...
    private static HttpURLConnection m13514a(String str, boolean z) {
        String defaultHost;
        ...
        try {
            ...
            if (C2260l.m13508c()) {
                ...
                C2261m.m13511a();
                z2 = !C2231b.m13370a(Proxy.getDefaultHost());
            }
            if (z2) {
                int defaultPort;
                if (f11742a == 0 && !f11743b) {
                    f11743b = true;
                    try {
                        ...
                        try {
                            ...
                            try {
                                httpURLConnection3.setRequestMethod(C2951i.f14860a);
                                httpURLConnection3.setConnectTimeout(15000);
                                httpURLConnection3.setReadTimeout(45000);
                                httpURLConnection3.setRequestProperty(C3004e.f15013Y, "QQ Map Mobile");
                                httpURLConnection3.setDoInput(true);
                                httpURLConnection3.setDoOutput(false);
                                httpURLConnection3.setUseCaches(false);
                                boolean a = C2265q.m13517a(httpURLConnection3);
    ...
    private static HttpURLConnection m13515a(URL url, String str) {
        int i = 80;
        ...
        try {
            HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(str.indexOf(new StringBuilder(String.valueOf(host)).append(":").append(i).toString()) != -1 ? str.replaceFirst(new StringBuilder(String.valueOf(host)).append(":").append(i).toString(), new StringBuilder(String.valueOf(defaultHost)).append(":").append(defaultPort).toString()) : str.replaceFirst(host, new StringBuilder(String.valueOf(defaultHost)).append(":").append(defaultPort).toString())).openConnection();
    ...
    private static void m13516a(int i) {
        if (f11742a != i) {
            f11742a = i;
        }
    }

    private static boolean m13517a(HttpURLConnection httpURLConnection) {
        InputStream inputStream = null;
        try {
            inputStream = httpURLConnection.getInputStream();
            ...
            boolean equals = new String(byteArrayOutputStream.toByteArray()).trim().equals(Constants.VIA_TO_TYPE_QQ_GROUP);
            if (inputStream == null) {
                return equals;
            }
            inputStream.close();
