...
public abstract class BaseApi {
    ...
    public class TempRequestListener implements IRequestListener {
        ...
        class C22111 extends Handler {
            final /* synthetic */ BaseApi val$this$0;

            C22111(Looper looper, BaseApi baseApi) {
        ...
        public TempRequestListener(IUiListener iUiListener) {
            this.mListener = iUiListener;
            this.mHandler = new C22111(Global.getContext().getMainLooper(), BaseApi.this);
        }
    ...
    static {
        ...
        sRequestCode = XiaomiOAuthConstants.SCOPE_ACCESS_MI_ROUTER;
    ...
    public static void handleDataToListener(Intent intent, IUiListener iUiListener) {
        ...
        if (SystemUtils.ACTION_LOGIN.equals(stringExtra2)) {
            ...
            if (intExtra == 0) {
                ...
                if (stringExtra != null) {
                    try {
                        ...
                        C2333f.m13755b(C2333f.f12014d, "OpenUi, onActivityResult, json error", e);
                        return;
                    }
                }
                C2333f.m13754b(C2333f.f12014d, "OpenUi, onActivityResult, onComplete");
                iUiListener.onComplete(new JSONObject());
                return;
            }
            C2333f.m13759e(C2333f.f12014d, "OpenUi, onActivityResult, onError = " + intExtra + C2915a.f14760f);
            ...
            if ("cancel".equals(stringExtra2)) {
                iUiListener.onCancel();
            } else if (XiaomiOAuthConstants.EXTRA_ERROR_CODE_2.equals(stringExtra2)) {
                iUiListener.onError(new UiError(-6, "unknown error", stringExtra + C2915a.f14760f));
            } else if ("complete".equals(stringExtra2)) {
                try {
                    iUiListener.onComplete(new JSONObject(stringExtra == null ? "{\"ret\": 0}" : stringExtra));
                } catch (JSONException e2) {
                    e2.printStackTrace();
                    iUiListener.onError(new UiError(-4, "json error", stringExtra + C2915a.f14760f));
                }
            }
        }
    }
    ...
    protected void handleDownloadLastestQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        new TDialog(context, C2915a.f14760f, stringBuilder.toString(), null, this.mToken).show();
    }
    ...
    public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
        ...
        iUiListener = null;
        if (iUiListener == null) {
            C2333f.m13754b(TAG, "BaseApi--onActivityResult-- listener == null");
