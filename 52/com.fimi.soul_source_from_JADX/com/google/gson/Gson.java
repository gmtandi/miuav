...
public final class Gson {
    ...
    class C20511 implements JsonDeserializationContext {
        C20511() {
        }
    ...
    class C20522 implements JsonSerializationContext {
        C20522() {
        }
    ...
    class C20533 extends TypeAdapter<Number> {
        C20533() {
        }
    ...
    class C20544 extends TypeAdapter<Number> {
        C20544() {
        }
    ...
    class C20555 extends TypeAdapter<Number> {
        C20555() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new C20511();
        this.serializationContext = new C20522();
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z) {
        return z ? TypeAdapters.DOUBLE : new C20533();
    }

    private TypeAdapter<Number> floatAdapter(boolean z) {
        return z ? TypeAdapters.FLOAT : new C20544();
    }

    private TypeAdapter<Number> longAdapter(LongSerializationPolicy longSerializationPolicy) {
        return longSerializationPolicy == LongSerializationPolicy.DEFAULT ? TypeAdapters.LONG : new C20555();
    }
