...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    final class C20731 implements Comparator<Comparable> {
        C20731() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C20741 extends LinkedTreeMapIterator<Entry<K, V>> {
            C20741() {
                super(null);
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C20751 extends LinkedTreeMapIterator<K> {
            C20751() {
                super(null);
            }
