...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C20691 extends TypeAdapter<T> {
        ...
        C20691(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return (excludeClass || excludeClass2) ? new C20691(excludeClass2, excludeClass, gson, typeToken) : null;
    }
