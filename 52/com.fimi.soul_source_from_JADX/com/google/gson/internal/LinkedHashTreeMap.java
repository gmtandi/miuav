...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    final class C20701 implements Comparator<Comparable> {
        C20701() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C20711 extends LinkedTreeMapIterator<Entry<K, V>> {
            C20711() {
                super(null);
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C20721 extends LinkedTreeMapIterator<K> {
            C20721() {
                super(null);
            }
