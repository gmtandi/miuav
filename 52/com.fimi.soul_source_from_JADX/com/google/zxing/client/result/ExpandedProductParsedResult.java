...
public class ExpandedProductParsedResult extends ParsedResult {
    ...
    ExpandedProductParsedResult() {
        ...
        this.productID = C2915a.f14760f;
        this.sscc = C2915a.f14760f;
        this.lotNumber = C2915a.f14760f;
        this.productionDate = C2915a.f14760f;
        this.packagingDate = C2915a.f14760f;
        this.bestBeforeDate = C2915a.f14760f;
        this.expirationDate = C2915a.f14760f;
        this.weight = C2915a.f14760f;
        this.weightType = C2915a.f14760f;
        this.weightIncrement = C2915a.f14760f;
        this.price = C2915a.f14760f;
        this.priceIncrement = C2915a.f14760f;
        this.priceCurrency = C2915a.f14760f;
