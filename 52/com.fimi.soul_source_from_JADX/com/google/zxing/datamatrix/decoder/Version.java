...
public final class Version {
    ...
    final class ECB {
        ...
        ECB(int i, int i2, C21011 c21011) {
            this(i, i2);
        }
    ...
    final class ECBlocks {
        ...
        ECBlocks(int i, ECB ecb, C21011 c21011) {
            this(i, ecb);
        }
        ...
        ECBlocks(int i, ECB ecb, ECB ecb2, C21011 c21011) {
            this(i, ecb, ecb2);
        }
    ...
    private static Version[] buildVersions() {
        return new Version[]{new Version(1, 10, 10, 8, 8, new ECBlocks(5, new ECB(1, 3, null), null)), new Version(2, 12, 12, 10, 10, new ECBlocks(7, new ECB(1, 5, null), null)), new Version(3, 14, 14, 12, 12, new ECBlocks(10, new ECB(1, 8, null), null)), new Version(4, 16, 16, 14, 14, new ECBlocks(12, new ECB(1, 12, null), null)), new Version(5, 18, 18, 16, 16, new ECBlocks(14, new ECB(1, 18, null), null)), new Version(6, 20, 20, 18, 18, new ECBlocks(18, new ECB(1, 22, null), null)), new Version(7, 22, 22, 20, 20, new ECBlocks(20, new ECB(1, 30, null), null)), new Version(8, 24, 24, 22, 22, new ECBlocks(24, new ECB(1, 36, null), null)), new Version(9, 26, 26, 24, 24, new ECBlocks(28, new ECB(1, 44, null), null)), new Version(10, 32, 32, 14, 14, new ECBlocks(36, new ECB(1, 62, null), null)), new Version(11, 36, 36, 16, 16, new ECBlocks(42, new ECB(1, 86, null), null)), new Version(12, 40, 40, 18, 18, new ECBlocks(48, new ECB(1, Opcodes.FREM, null), null)), new Version(13, 44, 44, 20, 20, new ECBlocks(56, new ECB(1, Opcodes.D2F, null), null)), new Version(14, 48, 48, 22, 22, new ECBlocks(68, new ECB(1, Opcodes.FRETURN, null), null)), new Version(15, 52, 52, 24, 24, new ECBlocks(42, new ECB(2, Opcodes.FSUB, null), null)), new Version(16, 64, 64, 14, 14, new ECBlocks(56, new ECB(2, Opcodes.F2L, null), null)), new Version(17, 72, 72, 16, 16, new ECBlocks(36, new ECB(4, 92, null), null)), new Version(18, 80, 80, 18, 18, new ECBlocks(48, new ECB(4, Opcodes.FREM, null), null)), new Version(19, 88, 88, 20, 20, new ECBlocks(56, new ECB(4, Opcodes.D2F, null), null)), new Version(20, 96, 96, 22, 22, new ECBlocks(68, new ECB(4, Opcodes.FRETURN, null), null)), new Version(21, Opcodes.IMUL, Opcodes.IMUL, 24, 24, new ECBlocks(56, new ECB(6, Opcodes.L2I, null), null)), new Version(22, Opcodes.ISHL, Opcodes.ISHL, 18, 18, new ECBlocks(68, new ECB(6, Opcodes.DRETURN, null), null)), new Version(23, Opcodes.IINC, Opcodes.IINC, 20, 20, new ECBlocks(62, new ECB(8, Opcodes.IF_ICMPGT, null), null)), new Version(24, Opcodes.D2F, Opcodes.D2F, 22, 22, new ECBlocks(62, new ECB(8, Opcodes.IFGE, null), new ECB(2, Opcodes.IFLT, null), null)), new Version(25, 8, 18, 6, 16, new ECBlocks(7, new ECB(1, 5, null), null)), new Version(26, 8, 32, 6, 14, new ECBlocks(11, new ECB(1, 10, null), null)), new Version(27, 12, 26, 10, 24, new ECBlocks(14, new ECB(1, 16, null), null)), new Version(28, 12, 36, 10, 16, new ECBlocks(18, new ECB(1, 22, null), null)), new Version(29, 16, 36, 10, 16, new ECBlocks(24, new ECB(1, 32, null), null)), new Version(30, 16, 48, 14, 22, new ECBlocks(28, new ECB(1, 49, null), null))};
    }
