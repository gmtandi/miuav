...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{ae.f9482j, 379}, "FR");
            add(new int[]{380}, "BG");
            add(new int[]{383}, "SI");
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{400, 440}, "DE");
            add(new int[]{C2799f.f14276n, 459}, "JP");
            ...
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, C1173l.f5337i);
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            add(new int[]{489}, "HK");
            add(new int[]{490, 499}, "JP");
            add(new int[]{C2799f.f14263a, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{759}, "VE");
            add(new int[]{760, C1314u.f5858K}, "CH");
            add(new int[]{C1314u.f5859L}, "CO");
            add(new int[]{773}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
