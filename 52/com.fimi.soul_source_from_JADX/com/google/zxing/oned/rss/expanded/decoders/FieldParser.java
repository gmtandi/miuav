...
final class FieldParser {
    ...
    static {
        ...
        r0[3] = new Object[]{Constants.VIA_REPORT_TYPE_SHARE_TO_QQ, VARIABLE_LENGTH, new Integer(20)};
        r0[4] = new Object[]{Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, new Integer(6)};
        r0[5] = new Object[]{Constants.VIA_REPORT_TYPE_SET_AVATAR, new Integer(6)};
        r0[6] = new Object[]{Constants.VIA_REPORT_TYPE_JOININ_GROUP, new Integer(6)};
        r0[7] = new Object[]{Constants.VIA_REPORT_TYPE_WPA_STATE, new Integer(6)};
        r0[8] = new Object[]{"17", new Integer(6)};
        r0[9] = new Object[]{"20", new Integer(2)};
        r0[10] = new Object[]{Constants.VIA_REPORT_TYPE_QQFAVORITES, VARIABLE_LENGTH, new Integer(20)};
        r0[11] = new Object[]{Constants.VIA_REPORT_TYPE_DATALINE, VARIABLE_LENGTH, new Integer(29)};
