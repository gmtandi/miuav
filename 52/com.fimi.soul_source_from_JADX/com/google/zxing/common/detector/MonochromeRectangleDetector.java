...
public final class MonochromeRectangleDetector {
    ...
    private ResultPoint findCornerFromCenter(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        while (i11 < i8 && i11 >= i7 && i10 < i4 && i10 >= i3) {
            ...
            if (blackWhiteRange != null) {
                ...
                return new ResultPoint(i6 > 0 ? (float) iArr[0] : (float) iArr[1], (float) r3);
            } else {
                r3 = i10 - i2;
                if (iArr[0] >= i5) {
    ...
    public ResultPoint[] detect() {
        ...
        int i = height >> 1;
        int i2 = width >> 1;
        int max = Math.max(1, height / Opcodes.ACC_NATIVE);
        int max2 = Math.max(1, width / Opcodes.ACC_NATIVE);
        ...
        width = ((int) findCornerFromCenter(i2, max2, x, width, i, 0, y, height, i >> 1).getX()) + 1;
        ResultPoint findCornerFromCenter = findCornerFromCenter(i2, 0, x, width, i, max, y, height, i2 >> 1);
        ResultPoint findCornerFromCenter2 = findCornerFromCenter(i2, 0, x, width, i, -max, y, ((int) findCornerFromCenter.getY()) + 1, i2 >> 2);
