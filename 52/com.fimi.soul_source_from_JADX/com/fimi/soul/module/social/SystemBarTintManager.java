...
public class SystemBarTintManager {
    ...
    public class SystemBarConfig {
        ...
        private boolean hasNavBar(Context context) {
            ...
            if (identifier != 0) {
                return Constants.VIA_TO_TYPE_QQ_GROUP.equals(SystemBarTintManager.sNavBarOverride) ? false : Constants.VIA_RESULT_SUCCESS.equals(SystemBarTintManager.sNavBarOverride) ? true : resources.getBoolean(identifier);
            } else {
