...
public class NetworkHelper {
    ...
    class C21731 implements HttpResponseCallback {
        final /* synthetic */ HashMap val$tmpMap;

        C21731(HashMap hashMap) {
        ...
        public void onResponse(HttpConnection httpConnection) {
            ...
            String readLine;
            if (responseCode == C2799f.f14282t || responseCode == bj.f6779b) {
            ...
            hashMap.put(XiaomiOAuthConstants.EXTRA_ERROR_CODE_2, stringBuilder2.toString());
            hashMap.put(RMsgInfo.COL_STATUS, Integer.valueOf(responseCode));
            throw new Throwable(new Hashon().fromHashMap(hashMap));
        }
    }

    /* renamed from: com.mob.tools.network.NetworkHelper.2 */
    class C21742 implements X509TrustManager {
        C21742() {
        }
    ...
    /* renamed from: com.mob.tools.network.NetworkHelper.3 */
    class C21753 implements HostnameVerifier {
        C21753() {
        }
    ...
    private HttpURLConnection getConnection(String str, NetworkTimeOut networkTimeOut) {
        ...
        if (instanceField != null) {
            ...
            obj[strArr.length] = C2954l.f14863a;
            if (i != 0) {
        ...
        if (httpURLConnection instanceof HttpsURLConnection) {
            ...
            instance.init(null, new X509TrustManager[]{new C21742()}, new SecureRandom());
            HttpsURLConnection.setDefaultSSLSocketFactory(instance.getSocketFactory());
            httpsURLConnection.setHostnameVerifier(new C21753());
        }
    ...
    private HTTPPart getFilePostHTTPPart(HttpURLConnection httpURLConnection, String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2) {
        ...
        httpURLConnection.setRequestProperty(C3004e.f15031q, "multipart/form-data; boundary=" + uuid);
    ...
    private HTTPPart getTextPostHTTPPart(HttpURLConnection httpURLConnection, String str, ArrayList<KVPair<String>> arrayList) {
        httpURLConnection.setRequestProperty(C3004e.f15031q, C2989l.f14939a);
    ...
    L_0x0109:
        r6 = new com.mob.tools.network.HttpConnectionImpl;	 Catch:{ Throwable -> 0x0150 }
        r6.<init>(r3);	 Catch:{ Throwable -> 0x0150 }
        r0 = r20;
        r0.onResponse(r6);	 Catch:{ Throwable -> 0x0150 }
    ...
    private String kvPairsToUrl(ArrayList<KVPair<String>> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            String urlEncode2 = kVPair.value != null ? Data.urlEncode((String) kVPair.value, "utf-8") : C2915a.f14760f;
            if (stringBuilder.length() > 0) {
                stringBuilder.append('&');
            }
            stringBuilder.append(urlEncode).append(SignatureVisitor.INSTANCEOF).append(urlEncode2);
        }
    ...
    public String downloadCache(Context context, String str, String str2, boolean z, NetworkTimeOut networkTimeOut) {
        ...
        MobLog.getInstance().m743i("downloading: " + str, new Object[0]);
        if (z) {
            File file = new File(C2178R.getCachePath(context, str2), Data.MD5(str));
            if (z && file.exists()) {
                MobLog.getInstance().m743i("use time: " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        ...
        if (responseCode == C2799f.f14282t) {
            ...
            if (headerFields != null) {
                list = (List) headerFields.get(AsyncHttpClient.HEADER_CONTENT_DISPOSITION);
                if (list != null && list.size() > 0) {
                    ...
                    if (str3 == null) {
                        MD5 = Data.MD5(str);
                        if (headerFields != null) {
                            list = (List) headerFields.get(C3004e.f15031q);
                            if (list != null && list.size() > 0) {
                                str3 = (String) list.get(0);
                                str3 = str3 != null ? C2915a.f14760f : str3.trim();
                    ...
                    file2 = new File(C2178R.getCachePath(context, str2), str3);
                    if (z || !file2.exists()) {
            ...
            connection.disconnect();
            HashMap hashMap = new HashMap();
            hashMap.put(XiaomiOAuthConstants.EXTRA_ERROR_CODE_2, stringBuilder.toString());
            hashMap.put(RMsgInfo.COL_STATUS, Integer.valueOf(responseCode));
            throw new Throwable(new Hashon().fromHashMap(hashMap));
        }
    }
    ...
    public String httpGet(String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) {
        String kvPairsToUrl;
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m743i("httpGet: " + str, new Object[0]);
        if (arrayList != null) {
    ...
    public ArrayList<KVPair<String[]>> httpHead(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m743i("httpHead: " + str, new Object[0]);
        if (arrayList != null) {
        ...
        HttpURLConnection connection = getConnection(str, networkTimeOut);
        connection.setRequestMethod(C2952j.f14861a);
        if (arrayList2 != null) {
            Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
    ...
    public String httpPost(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) {
        ...
        return httpPostFiles(str, arrayList, arrayList3, arrayList2, networkTimeOut);
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void httpPost(java.lang.String r10, java.util.ArrayList<com.mob.tools.network.KVPair<java.lang.String>> r11, java.util.ArrayList<com.mob.tools.network.KVPair<java.lang.String>> r12, java.util.ArrayList<com.mob.tools.network.KVPair<java.lang.String>> r13, com.mob.tools.network.HttpResponseCallback r14, com.mob.tools.network.NetworkHelper.NetworkTimeOut r15) {
        /*
        r9 = this;
        r8 = 0;
        r2 = java.lang.System.currentTimeMillis();
    ...
    L_0x0031:
        r0 = r9.getFilePostHTTPPart(r4, r10, r11, r12);
    ...
    L_0x0045:
        ...
        goto L_0x003f;
    L_0x0055:
        r0 = r9.getTextPostHTTPPart(r4, r10, r11);
        r6 = r0.length();
        r1 = (int) r6;
    ...
    L_0x008b:
        r0 = new com.mob.tools.network.HttpConnectionImpl23;	 Catch:{ Throwable -> 0x00b9 }
        r0.<init>(r4);	 Catch:{ Throwable -> 0x00b9 }
        r14.onResponse(r0);	 Catch:{ Throwable -> 0x00b9 }
        r4.disconnect();
    L_0x0096:
        r0 = com.mob.tools.MobLog.getInstance();
        r1 = new java.lang.StringBuilder;
    ...
    L_0x00c0:
        ...
        goto L_0x0096;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mob.tools.network.NetworkHelper.httpPost(java.lang.String, java.util.ArrayList, java.util.ArrayList, java.util.ArrayList, com.mob.tools.network.HttpResponseCallback, com.mob.tools.network.NetworkHelper$NetworkTimeOut):void");
    }
    ...
    public String httpPostFiles(String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2, ArrayList<KVPair<String>> arrayList3, NetworkTimeOut networkTimeOut) {
        HashMap hashMap = new HashMap();
        httpPost(str, arrayList, arrayList2, arrayList3, new C21731(hashMap), networkTimeOut);
    ...
    public String httpPut(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) {
        String kvPairsToUrl;
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m743i("httpPut: " + str, new Object[0]);
        if (arrayList != null) {
            kvPairsToUrl = kvPairsToUrl(arrayList);
            if (kvPairsToUrl.length() > 0) {
                str = str + "?" + kvPairsToUrl;
        ...
        connection.setRequestMethod(C2956n.f14865a);
        connection.setRequestProperty(C3004e.f15031q, RequestParams.APPLICATION_OCTET_STREAM);
        if (arrayList2 != null) {
            Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
                KVPair kVPair2 = (KVPair) it.next();
    ...
    public String jsonPost(String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m743i("jsonPost: " + str, new Object[0]);
        HttpURLConnection connection = getConnection(str, networkTimeOut);
        connection.setDoOutput(true);
        connection.setChunkedStreamingMode(0);
        ...
        hashMap2.put(XiaomiOAuthConstants.EXTRA_ERROR_CODE_2, stringBuilder2.toString());
        hashMap2.put(RMsgInfo.COL_STATUS, Integer.valueOf(responseCode));
    ...
    public void rawGet(String str, RawNetworkCallback rawNetworkCallback, NetworkTimeOut networkTimeOut) {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m743i("rawGet: " + str, new Object[0]);
        HttpURLConnection connection = getConnection(str, networkTimeOut);
        connection.connect();
        int responseCode = connection.getResponseCode();
        if (responseCode == C2799f.f14282t) {
