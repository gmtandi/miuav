...
public class MobViewPager extends ViewGroup {
    ...
    private void init(Context context) {
        this.scroller = new Scroller(getContext(), new C21651());
