...
public class Data {
    ...
    public static String AES128Decode(String str, byte[] bArr) {
        return (str == null || bArr == null) ? null : new String(AES128Decode(str.getBytes(C1142e.f5201a), bArr), C1142e.f5201a);
    }
    ...
    public static byte[] AES128Encode(byte[] bArr, String str) {
        return (bArr == null || str == null) ? null : AES128Encode(bArr, str.getBytes(C1142e.f5201a));
    }
    ...
    public static String CRC32(byte[] bArr) {
        ...
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 56))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 48))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 40))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 32))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 24))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 16))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 8))) & Util.MASK_8BIT)}));
        stringBuilder.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) value)) & Util.MASK_8BIT)}));
    ...
    public static byte[] rawRSADecode(byte[] bArr, byte[] bArr2, int i) {
        ...
        RSAPrivateKey rSAPrivateKey = (RSAPrivateKey) KeyFactory.getInstance(RSAUtil.ALGORITHM_RSA).generatePrivate(new PKCS8EncodedKeySpec(bArr2));
    ...
    public static byte[] rawRSAEncode(byte[] bArr, byte[] bArr2, int i) {
        int i2 = (i / 8) - 11;
        RSAPublicKey rSAPublicKey = (RSAPublicKey) KeyFactory.getInstance(RSAUtil.ALGORITHM_RSA).generatePublic(new X509EncodedKeySpec(bArr2));
        Cipher instance = Cipher.getInstance("RSA/None/PKCS1Padding");
