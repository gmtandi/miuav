...
public class Hashon {
    ...
    private String format(String str, HashMap<String, Object> hashMap) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            stringBuffer.append(str2).append(C3022o.f15057e).append((String) entry.getKey()).append("\":");
    ...
    private HashMap<String, Object> fromJson(JSONObject jSONObject) {
    ...
    public String format(String str) {
        try {
            return format(C2915a.f14760f, fromJson(str));
        } catch (Throwable th) {
    ...
    public String fromHashMap(HashMap<String, Object> hashMap) {
        try {
            ...
            return jSONObject == null ? C2915a.f14760f : jSONObject.toString();
        } catch (Throwable th) {
            MobLog.getInstance().m750w(th);
            return C2915a.f14760f;
        }
    ...
    public HashMap<String, Object> fromJson(String str) {
        ...
        try {
            ...
            MobLog.getInstance().m749w(str, new Object[0]);
            MobLog.getInstance().m750w(th);
            return new HashMap();
        }
    }
