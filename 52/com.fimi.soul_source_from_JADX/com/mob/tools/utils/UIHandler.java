...
public class UIHandler {
    ...
    /* renamed from: com.mob.tools.utils.UIHandler.1 */
    final class C21821 implements Callback {
        C21821() {
        }
    ...
    final class InnerObj {
        public final Callback callback;
        public final Message msg;

        public InnerObj(Message message, Callback callback) {
            this.msg = message;
    ...
    private static void reset() {
        handler = new Handler(Looper.getMainLooper(), new C21821());
    }
