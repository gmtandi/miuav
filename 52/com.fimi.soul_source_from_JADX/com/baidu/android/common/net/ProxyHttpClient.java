...
public class ProxyHttpClient extends DefaultHttpClient {
    ...
    static {
        TAG = ProxyHttpClient.class.getSimpleName();
    }
    ...
    public ProxyHttpClient(Context context, String str, ConnectManager connectManager) {
        ...
        HttpConnectionParams.setSocketBufferSize(getParams(), Opcodes.ACC_ANNOTATION);
    ...
    protected void finalize() {
        super.finalize();
        if (this.mLeakedException != null) {
            Log.m5951e(TAG, "Leak found", this.mLeakedException);
        }
    }
